...
class _FeesScreenState extends ConsumerState<FeesScreen> {
          ...
          return Column(
            children: [
                  ...
                  children: [
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<String>(
                                ...
                                items: _classes.map((c) => DropdownMenuItem(
                                  value: c,
                                  child: Text(c == 'All' ? 'All Classes' : 'Class $c', style: const TextStyle(fontSize: 13)),
                                )).toList(),
                          ...
                          child: Container(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<String>(
                                ...
                                isExpanded: true,
                                items: ['All', 'Paid', 'Due'].map((s) => DropdownMenuItem(
                                  value: s,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          _bannerStat('Total Fee', '₹${grandTotal.toStringAsFixed(0)}'),
                          Container(width: 1, height: 30, color: Colors.white30),
                          _bannerStat('Collected', '₹${grandPaid.toStringAsFixed(0)}'),
                          Container(width: 1, height: 30, color: Colors.white30),
                          _bannerStat('Due', '₹${(grandTotal - grandPaid).toStringAsFixed(0)}'),
                        ],
                      ),
                    ),
                  ],
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text('${students.length} Students', style: TextStyle(fontWeight: FontWeight.w600, color: Colors.grey[700], fontSize: 13)),
                    const Spacer(),
                    Icon(Icons.sort_rounded, size: 16, color: Colors.grey[400]),
                    Text(' Class wise', style: TextStyle(color: Colors.grey[400], fontSize: 11)),
                  ],
                ),
              ),
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                    ...
                    final totalPaid = (fee?['total_paid'] as num?)?.toDouble() ?? 0;
                      ...
                      child: ListTile(
                        ...
                        leading: CircleAvatar(
                          ...
                          child: Icon(
                            ...
                            status == 'DUE' ? Icons.warning_rounded : Icons.remove_circle_outline,
                        ...
                        trailing: Column(
                          ...
                          children: [
                            if (totalAmount > 0)
                              Text('₹${totalPaid.toStringAsFixed(0)} / ₹${totalAmount.toStringAsFixed(0)}',
  ...
  void _showStudentFeeDetail(StudentModel student, Map<String, dynamic>? feeSummary) async {
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  CircleAvatar(
                    ...
                    child: Text(student.name[0], style: TextStyle(fontWeight: FontWeight.bold, color: Colors.blue[700])),
                  ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: totalDue > 0 ? Colors.red.withOpacity(0.06) : Colors.green.withOpacity(0.06),
                ...
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: [
                        _detailStat('Total Fee', '₹${totalAmount.toStringAsFixed(0)}', Colors.blue),
                        _detailStat('Paid', '₹${totalPaid.toStringAsFixed(0)}', Colors.green),
                        _detailStat('Due', '₹${totalDue.toStringAsFixed(0)}', Colors.red),
                      ],
                    ),
                    ...
                    ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                        value: totalAmount > 0 ? (totalPaid / totalAmount).clamp(0, 1) : 0,
                        minHeight: 8,
                        backgroundColor: Colors.grey[200],
                        valueColor: AlwaysStoppedAnimation(totalPaid >= totalAmount ? Colors.green : Colors.orange),
                      ),
                    ),
                  ],
                ),
              ...
              Expanded(
                child: records.isEmpty
                    ? Center(child: Text('No fee records', style: TextStyle(color: Colors.grey[400])))
                    : ListView.builder(
                        ...
                        itemBuilder: (ctx, i) {
                          ...
                          final sColor = status == 'paid' ? Colors.green : status == 'overdue' ? Colors.red : Colors.orange;
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text(r['fee_type']?.toString().toUpperCase() ?? '',
                                          style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 12)),
                                      Text('Due: ${r['due_date'] ?? '—'}${r['paid_date'] != null ? ' • Paid: ${r['paid_date']}' : ''}',
